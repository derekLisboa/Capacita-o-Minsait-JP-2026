...
public class CartController {
    ...
    @PostMapping("/items")
    @Operation(summary = "Adicionar produto no carrinho", description = "Adiciona um produto ao carrinho do usuário")
    ...
    @GetMapping
    @Operation(summary = "Buscar carrinho", description = "Retorna o carrinho do usuario com todos os itens e valor total")
    ...
    @Operation(summary = "Remover produto do carrinho", description = "Remove uma quantidade especifica do produto. Se for maior ou igual a quantidade atual, remove o item completamente")
